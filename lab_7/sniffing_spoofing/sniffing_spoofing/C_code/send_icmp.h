...
void send_raw_ip_packet(void *pkt);

/******************************************************************
  Spoof an ICMP echo request using an arbitrary source IP Address
*******************************************************************/
int send_icmp(struct in_addr srcip, struct in_addr dstip, unsigned short int id, unsigned short seq)
{
    // printf("%s\n", SRC_IP);
    // printf("%s\n", DEST_IP);
    ...
    send_raw_ip_packet((void *)buffer);
